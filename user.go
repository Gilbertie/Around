...
var mySigningKey = []byte("xuexishiwokuaile")
...
func handlerLogin(w http.ResponseWriter, r *http.Request) {
	...
	// get user date from request
	decoder := json.NewDecoder(r.Body)
	var user User
	if err := decoder.Decode(&user); err != nil {
		http.Error(w, "Failed to read user date", http.StatusBadRequest)
		return
	}

	// verify user nama and password
