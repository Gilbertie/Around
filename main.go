...
func handlerSearch(w http.ResponseWriter, r *http.Request) {
	...
	query.Lat(lat).Lon(lon).Distance(ran)
	...
	if err != nil {
		http.Error(w, "Failed to pass post into JSON object", http.StatusInternalServerError)
		return
	}
	w.Write(js)
}
